...
const envSchema = z.object({
  ...
  NOTION_TASK_DEFINITIONS_DATASOURCE_ID: z.string().default(""),
...
export const ENV = {
  ...
  notionTaskCompletionDatabaseId: e.NOTION_TASK_COMPLETION_DATABASE_ID,
  notionTaskDefinitionsDbId: e.NOTION_TASK_DEFINITIONS_DATABASE_ID,
  notionTaskDefinitionsDataSourceId: e.NOTION_TASK_DEFINITIONS_DATASOURCE_ID || e.NOTION_TASK_DEFINITIONS_DATABASE_ID,
  notionValidationResultsDataSourceId: e.NOTION_VALIDATION_RESULTS_DATASOURCE_ID || e.NOTION_VALIDATION_RESULTS_DATABASE_ID,
  notionValidationResultsDatabaseId: e.NOTION_VALIDATION_RESULTS_DATABASE_ID,
