...
interface PageBreadcrumbProps {
  /** Full org path prefix, e.g. "/org/RadOne/my-hospital". Takes precedence over orgSlug. */
  orgPath?: string;
  /** @deprecated Pass orgPath instead */
  orgSlug?: string;
  items: BreadcrumbItem[];
}

export function PageBreadcrumb({ orgPath, orgSlug, items }: PageBreadcrumbProps) {
  const dashboardHref = orgPath ?? `/org/${orgSlug}`;
  return (
