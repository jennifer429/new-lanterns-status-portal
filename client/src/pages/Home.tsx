          ...
          <CardContent className="p-5">
            <div className="space-y-1.5 mb-5">
              {sectionProgress.map((section, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between py-3 px-4 rounded-xl hover:bg-accent/50 transition-colors"
                >
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    {/* Mini progress bar */}
                    <div className="w-20 h-1.5 bg-muted/40 rounded-full overflow-hidden hidden sm:block">
                      <div
                        className={cn(
                          "h-full rounded-full transition-all duration-500",
                          section.isComplete
