...
import { LayoutDashboard, ClipboardList, FlaskConical, ListChecks, RefreshCw } from "lucide-react";
...
export default function Home() {
  ...
  const navItems = [
    ...
    // "Knowledge" hidden: it only links to the document-upload library, which is
    // misleading as a "Knowledge Hub" until the §7 Q&A reframe lands. Re-add then.
  ];
