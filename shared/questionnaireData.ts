...
export const questionnaireSections: Section[] = [
  {
    ...
    questions: [
      { id: 'H.1', text: 'Number of sites/locations', type: 'text', placeholder: 'Enter number of sites' },
      ...
      { id: 'L.4', text: 'Integration testing timeline', type: 'date', placeholder: 'MM/DD/YYYY' },
      { id: 'L.5', text: 'User acceptance testing (UAT) timeline', type: 'date', placeholder: 'MM/DD/YYYY' },
  ...
  },
  {
    ...
    questions: [
      { id: 'A.7', text: 'Do you have an integration engine?', type: 'dropdown', options: ['Yes', 'No'] },
      { id: 'A.8', text: 'Do you have a router?', type: 'dropdown', options: ['Yes', 'No'] },
      ...
      { id: 'A.12', text: 'What is your current archive system?', type: 'text', placeholder: 'Example: GE' },
      { id: 'A.13', text: 'System that produces DICOM SR', type: 'text', placeholder: 'Enter system name if applicable' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'D.5', text: 'How will comparison images for priors be obtained?', type: 'dropdown', options: ['1) Manually pushed', '2) Automatically pushed by your system', '3) Pull from your system (C-FIND)'] },
      ...
      { id: 'D.8', text: 'Tech sheets input method', type: 'dropdown', options: ['1) Automatically as DICOM SR', '2) Manually as PDF'] },
  ...
  },
  {
    ...
    description: 'Required file uploads for configuration',
    questions: [
