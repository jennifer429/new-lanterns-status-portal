...
## Fix File Download Bug (DEFERRED - Come back to this)
- [ ] Investigate why download button redirects to Notion (need user to show exact location)
- [ ] Fix file URL storage/retrieval to use correct S3 URLs
- [ ] Test download functionality across all file types

## Fix User Login Redirect
- [x] Update login to redirect users directly to their intake questionnaire
- [x] Skip the landing page for regular users (only show to admins)
- [x] Test login flow for both admin and regular users

## Improve Form Field Visual States
- [x] Make unchecked checkboxes more visible with white outline
- [x] Add white border to empty input fields
- [x] Change border to purple when field is completed
- [x] Hide red asterisk (*) when required field is filled
- [x] Test visual states across all question types
