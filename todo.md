...
## User Management UI Restoration
- [ ] Check yesterday's ManageUsers page format from git checkpoint
- [ ] Redesign ManageUsers to table format (like organizations table)
- [ ] Add last login column to user table
- [ ] Add edit button for each user
- [ ] Implement edit user functionality (update name, email, role, organization)
- [ ] Test user list and edit functionality
