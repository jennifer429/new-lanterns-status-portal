...
## Fix Deprecated Feature Warning When Creating Org (Feb 10, 2026)
- [ ] Check browser console logs for deprecation warnings
- [ ] Check server logs for deprecation warnings
- [ ] Identify which deprecated feature is being used
- [ ] Fix the deprecated code
- [ ] Test that warning no longer appears

## Fix File Uploads Spinning Indefinitely (Feb 10, 2026)
- [ ] Check network requests for upload failures
- [ ] Check if upload mutation is completing
- [ ] Check if file storage (S3) is working
- [ ] Check if loading state is being reset properly
- [ ] Fix the upload issue
- [ ] Test that uploads complete successfully

## Fix CORS/CORB Errors Blocking API Requests (Feb 10, 2026)
- [ ] Check CORS configuration in server/_core/index.ts
- [ ] Verify CORS headers are being sent correctly
- [ ] Check if origin is being allowed properly
- [ ] Fix CORS configuration
- [ ] Test that API requests work without CORB errors
